...
filepath = r"c:\minor project\Plant-Leaf-Disease-Prediction-main (1)\Plant-Leaf-Disease-Prediction-main\model.h5"
model = load_model(filepath)
print(model)

print("Model Loaded Successfully")

tomato_plant = cv2.imread(r"c:\minor project\Plant-Leaf-Disease-Prediction-main (1)\Plant-Leaf-Disease-Prediction-main\Dataset\test\Tomato___Bacterial_spot (1).JPG")
